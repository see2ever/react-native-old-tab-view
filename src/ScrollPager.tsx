...
export default class ScrollPager<T extends Route> extends React.Component<Props<T> & { overscroll?: boolean }, State> {
  static defaultProps = {
    bounces: true,
  };
  ...
  componentDidUpdate(prevProps: Props<T>) {
    ...
    if (
      prevProps.navigationState.routes.length !== this.props.navigationState.routes.length ||
  ...
  private position = new Animated.Value(this.props.navigationState.index * this.props.layout.width);
  ...
  render() {
    const { children, layout, onSwipeStart, onSwipeEnd, overscroll, onIndexChange, navigationState } = this.props;
